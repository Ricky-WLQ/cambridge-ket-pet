...
PART_SPECS: dict[tuple[ExamType, int], PartSpec] = {
    ...
    ("KET", 1): PartSpec(
        ...
        specific_rules=[
            "Each item is a stand-alone short text under 25 words (sign, notice, email, or message).",
            "The student matches each text to one of 8 descriptions (A-H). Only 6 match.",
            "The 'prompt' field contains the text itself, prefixed with the item number.",
            "The 'answer' field is a single letter A-H.",
            "Cover practical everyday scenarios: shops, transport, school, food, travel.",
        ],
    ),
    ("KET", 2): PartSpec(
