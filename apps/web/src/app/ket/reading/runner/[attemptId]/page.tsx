...
export default async function KetReadingRunnerPage({
  params,
}: {
  ...
  if (attempt.test.examType !== "KET") redirect(`/pet/reading/runner/${attemptId}`);
  ...
  // Scrub the answer field before handing to the client component
