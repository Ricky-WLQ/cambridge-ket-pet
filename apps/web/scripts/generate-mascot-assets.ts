...
const POSES: Pose[] = [
  ...
  { slug: "flashcards", verb: "holding up a large bright alphabet letter card showing a clear capital letter A or B, three to four colorful floating cartoon letter shapes around the head (A, B, C, D), full body view, encouraging smile" },
  { slug: "chart", verb: "standing beside a small green chalkboard easel that shows a simple cartoon sentence-structure diagram (three colored rectangles connected by curving lines with arrow tips, like a sentence tree), holding a small wooden pointer, full body view, teaching pose" },
